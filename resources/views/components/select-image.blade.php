...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
      ...
      <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="{{ $modal }}-title">
        <header class="modal__header">
          <h2 class="text-xl text-gray-700" id="{{ $modal }}-title">
            ファイルを選択してください/Please choose files
          </h2>
        ...
        <footer class="modal__footer">
          <button type="button" class="modal__btn" data-micromodal-close aria-label="閉じる">閉じる/Close</button>
        </footer>
      </div>
    </div>
</div>
  ...
  <div class="flex justify-around items-center mb-4">
    <a data-micromodal-trigger="{{ $modal }}" class="py-2 px-4 bg-gray-400" href='javascript:;'>ファイルを選択/Choose files</a>
      <div class="w-1/4">
