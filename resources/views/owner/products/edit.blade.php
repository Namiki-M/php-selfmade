                  ...
                  <x-flash-message status="session('status')" />
                    <form method="post" action="{{ route('owner.products.update', ['product' => $product->id]) }}">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="price" class="leading-7 text-sm text-gray-600">値段 ※必須</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="shop_id" class="leading-7 text-sm text-gray-600">販売店舗 ※必須<</label>
                            ...
                            <div class="relative">
                                ...
                                <select name="category" id="category" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    ...
                                    <optgroup label="{{ $category->name }}">
                                        ...
                                        <option value="{{ $secondary->id }}" @if($secondary->id === $product->secodary_category_id) selected @endif>
                                        {{ $secondary->name }}
                                        </option>
                                        @endforeach
                                        @endforeach
                          ...
                          {{-- なぜか、最後の<x-select-image>のみ画像をデータ取得できないため、１つ余分に作成。 --}}
                          <div class="hidden">
                            <x-select-image :images="$images" name="image5" class="hidden" /> 
                          </div>
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
